export const en = {
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        subtitle: "Manage entire process",
        description:
  ...
  pricing: {
    ...
    subtitle: "Subscribe to a reasonable pricing plan for all designers.",
    monthly: "Monthly",
    ...
    plans: [
      {
        name: "Free",
        targetUser: "New Designer",
        price: "0",
        priceYearly: "0",
        badge: null,
        features: [
          { text: "1 work order sheet", included: true },
          { text: "42 basic templates by category (vector AI schematics)", included: true },
          { text: "1GB storage limit", included: true },
          { text: "AI automatic pattern upload and recommendation", included: false },
          { text: "Brand-specific customization (API)", included: false },
        ],
      },
      {
        name: "Pro",
        targetUser: "Student Designer",
        price: "35000",
        priceYearly: "24500",
        badge: "Popular",
        badgeColor: "yellow",
        features: [
          { text: "3 work order sheets", included: true },
          { text: "4,000 templates (vector AI schematics and CAD patterns)", included: true },
          { text: "20GB storage limit", included: true },
          { text: "AI automatic pattern upload and recommendation", included: true },
          { text: "Brand-specific customization (API)", included: false },
        ],
      },
      {
        name: "Business",
        targetUser: "Current Designer",
        price: "70000",
        priceYearly: "49000",
        badge: "Best",
        badgeColor: "blue",
        features: [
          { text: "Unlimited work order sheet creation", included: true },
          { text: "4,000 templates (vector AI schematics and CAD patterns)", included: true },
          { text: "300GB storage limit", included: true },
          { text: "AI automatic pattern upload and recommendation", included: true },
          { text: "Brand-specific customization (API)", included: true },
        ],
      },
      {
        name: "Enterprise (B2B)",
        ...
        price: null,
        priceYearly: null,
        priceCustom: "Price by negotiation",
        badge: null,
        features: [
          { text: "Unlimited work order sheet creation", included: true },
          { text: "4,000 templates (vector AI schematics and CAD patterns)", included: true },
          { text: "AI automatic pattern upload and recommendation", included: true },
          { text: "Production order customization", included: true },
          { text: "Apparel manufacturing agency (fabric, sewing, etc.)", included: false },
        ],
      },
    ],
  },
  footer: {
    slogan: "To enable anyone to start fashion design,\nwe connect everything from planning to work orders.",
    companyName: "Faddit Co., Ltd.",
    ceo: "CEO Choi Seong-rak",
    businessNumber: "Business Registration Number: 521-87-03693",
    address: "308, Samuiwon Startup Center, 26, Kyunghee-daero, Dongdaemun-gu, Seoul",
    contact: "Marketing and Business Partnership Inquiries: ceo@faddit.co.kr",
  ...
  contactPage: {
    ...
    cards: {
      email: {
        title: "Email",
        instruction: "Please send your inquiries by email anytime.",
        value: "seok@faddit.co.kr",
      },
      phone: {
        title: "Phone",
        instruction: "Available for connection on weekdays from 10 AM to 6 PM.",
        value: "010-4435-6141",
      },
      office: {
        title: "Office",
        instruction: "If you wish for an in-person consultation, please inquire anytime.",
        value: "308, Samuiwon Startup Center, 26, Kyungheedae-ro, Dongdaemun-gu, Seoul",
      },
    },
    form: {
    ...
    privacy: {
      intro: "'faddit' hereby notifies and guides you on the following matters regarding the collection, use, and processing of personal information in accordance with relevant laws and regulations.",
      item1: "Purpose of information collection: Consultation for service provision and contract fulfillment",
      item2: "Collected items: Name, company name, mobile phone number, email, inquiry details",
      item3: "Retention period: 6 months from the date of consultation completion",
      item4: "Personal information management inquiry: Email seok@faddit.co.kr",
